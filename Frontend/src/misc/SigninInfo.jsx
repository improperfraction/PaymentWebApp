...
function SigninInfo() {
    return (
        <section className="w-[448px] h-[412px] hidden lg:block rounded-bl-2xl rounded-tl-2xl relative overflow-hidden bg-gradient-to-br from-red-300 via-red-500 to-red-700 text-white py-6">
            ...
            <div className=" px-6 lg:px-20">
                ...
                Sign in to your account to access your dashboard, make transfers, and manage your financial world.</p>
